...
- `contextFileName`: The name of the file that contains the context for the extension. This will be used to load the context from the extension directory. If this property is not used but a `VOYAGER.md` file is present in your extension directory, then that file will be loaded.
