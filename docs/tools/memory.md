...
The tool appends the provided `fact` to a special `VOYAGER.md` file located in the user's home directory (`~/.gemini/VOYAGER.md`). This file can be configured to have a different name.
